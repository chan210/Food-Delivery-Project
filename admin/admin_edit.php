...
<div class="container">
  <table class="table table-bordered">
    <thead>
      <tr>
        <th colspan='2'><u>Edit Admin</u></th>
      </tr>
    </thead>
    <tbody>
...
$sql = "UPDATE admin SET firstname='$firstname', middlename='$middlename', lastname='$lastname', contact='$contact', email='$email', secret='$secret', password='$z'WHERE id='$id'";

if ($conn->query($sql) === TRUE) {
    echo "<center><h1><a href='admin_list.php'> Updated successful, Click here to go to the list. </a></center></h1>";
} else {
