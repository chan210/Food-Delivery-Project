...
$sql = "UPDATE user SET firstname='$firstname', middlename='$middlename', lastname='$lastname', contact='$contact', email='$email', secret='$secret', password='$z'WHERE id='$id'";

if ($conn->query($sql) === TRUE) {
    echo "<center><h1><a href='user_list.php'> Updated successful, Click here to go to the list. </a></center></h1>";
} else {
